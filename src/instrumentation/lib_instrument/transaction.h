...
public:
    typedef std::list<t_ptr<t_transaction_observation> > t_transactions;
    typedef std::list<t_ptr<t_oracle_observation> > t_oracles;
    typedef std::list<t_ptr<t_probe_observation> > t_probes;
    ...
    virtual void observation (const t_ptr<t_transaction_observation> & obs);
    virtual void observation (const t_ptr<t_oracle_observation> & obs);
    virtual void observation (const t_ptr<t_probe_observation> & obs);
