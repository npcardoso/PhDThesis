...
implements SpectrumMatcher<A, TM, CM> {
    ...
    private final List<SpectrumMatcher< ? super A, ? super TM, ? super CM> > matchers =
        new LinkedList<SpectrumMatcher< ? super A, ? super TM, ? super CM> > ();
    ...
    public CouplerMatcher (Coupler coupler,
                           SpectrumMatcher< ? super A, ? super TM, ? super CM> ... matchers) {
        this.coupler = coupler;

        for (SpectrumMatcher< ? super A, ? super TM, ? super CM> m : matchers) {
            this.matchers.add(m);
        }
    }
    ...
    public BitSet matchComponents (Spectrum< ? extends A, ? extends TM, ? extends CM> spectrum) {
        ...
        for (SpectrumMatcher< ? super A, ? super TM, ? super CM> matcher : matchers) {
